...
league_EUW <- read.table(
  file = "~/Documents/GitHub/FP_MiloSchmitt_MattViana/games.csv",
  header = TRUE,
  sep = ','
)

league_BR <- read.table(
  file = "~/Documents/GitHub/FP_MiloSchmitt_MattViana/full_data_100.csv",
  header = TRUE,
  sep = ','
)
...
```{r first blood, echo=FALSE, message=FALSE, warning=FALSE}
